...
- **[Zsh](https://www.zsh.org/)**: Shell configuration with [Powerlevel10k](https://github.com/romkatv/powerlevel10k) theme and useful plugins
...
```bash
brew install git stow zsh neovim tmux fzf zoxide tree
```
...
8. **Configure [Powerlevel10k](https://github.com/romkatv/powerlevel10k)**
